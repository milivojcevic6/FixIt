...
<div class="row">
    <div class="col-md-6">
        ...
        <p>
            Lorem Ipsum is inting and typesetting in simply dummy text of the printing and typesetting industry. Lorem
    ...
    <div class="col-md-6">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="contact-info">
                    <h5>Address</h5>
                    <p>Glagoljaška ulica 8, 6000 Koper - Slovenia</p>
        ...
        <p>
            Lorem ipsumn qersl ioinm sersoe non urna dolor sit amet, consectetur piesn qersl ioinm sersoe non urna dolor
            aecena.
        </p>
    </div>
</div>